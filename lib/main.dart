...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: NearbyProfilesScreen(),
    );
  }
}

class NearbyProfilesScreen extends StatefulWidget {
  const NearbyProfilesScreen({super.key});

  @override
  State<NearbyProfilesScreen> createState() => _NearbyProfilesScreenState();
}

class _NearbyProfilesScreenState extends State<NearbyProfilesScreen> {
                    ...
                    Column(
                      children: [
                        ...
                        Align(
                          alignment: Alignment.center,
                          child: Container(
                            // padding: const EdgeInsets.all(5), // space for the border
